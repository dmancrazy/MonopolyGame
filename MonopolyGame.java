...
public class MonopolyGame {
	...
	public void setup() {
		...
		// Makes sure that a proper number of players are picked (1 to 4). If not, the exception is caught and user is reprompted
		// If the user fails to input a proper integer twice, they play alone with a bot by default
		try {
			check = sc.nextLine();
		...
		// Prompt for players' names depending on the number picked
		...
		// If 1 is picked, they automatically play with a bot
		if (numberOfHumans == 1) {
		...
		// If 3 or less is picked, they are asked if they want a bot in their game
		// If an invalid value is given, it is assumed by default that they don't want a bot
	...
	*/
	...
	/**
	 * This method is how the player will interect with the game
	 * Player information messages are given during the players turn like current position and balance
	...
	/**
	 * This method is how the bot will interect with the game. More automated than humanTurn
	 * Bot's information messages are given during the bot's turn like current position and balance
	 * @param theBot The bot player
	 */
	...
	/**
	 * This method dictates how the players in the game interact with the Jail
	 * They can either roll, pay bail or stay in jail
