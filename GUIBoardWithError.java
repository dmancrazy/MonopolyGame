...
public void start(Stage PrimaryStage) throws Exception{
	...
	// The action that occurs after number of players is picked		
		Ok.setOnAction(new EventHandler<ActionEvent>() {
			...
			// according to the # of players picked, it will prompt their names
				...
				if (numChoice.getValue() == 1) {
					pCard1.getChildren().addAll(new Label("Player 1 name: " + enteredNames.get(0)), new Label("Player 1 balance: "));
					botCard.getChildren().addAll(new Label("Bot name: "), new Label("Bot balance: "));
					pCard1.setStyle("-fx-border-color: black");
					botCard.setStyle("-fx-border-color: black");
			
				}
				else if (numChoice.getValue() == 2) {
					pCard1.getChildren().addAll(new Label("Player 1 name: " + enteredNames.get(0)), new Label("Player 1 balance: "));
					pCard2.getChildren().addAll(new Label("Player 2 name: " + enteredNames.get(1)), new Label("Player 2 balance: "));
					pCard1.setStyle("-fx-border-color: black");
					pCard2.setStyle("-fx-border-color: black");

				}
				else if (numChoice.getValue() == 3) {
					pCard1.getChildren().addAll(new Label("Player 1 name: " + enteredNames.get(0)), new Label("Player 1 balance: "));
					pCard2.getChildren().addAll(new Label("Player 2 name: " + enteredNames.get(1)), new Label("Player 2 balance: "));
					pCard3.getChildren().addAll(new Label("Player 3 name: " + enteredNames.get(2)), new Label("Player 3 balance: "));
					pCard1.setStyle("-fx-border-color: black");
					pCard2.setStyle("-fx-border-color: black");
					pCard3.setStyle("-fx-border-color: black");
					...
					pCard2.getChildren().addAll(new Label("Player 2 name: " + enteredNames.get(1)), new Label("Player 2 balance: "));
					pCard3.getChildren().addAll(new Label("Player 3 name: " + enteredNames.get(2)), new Label("Player 3 balance: "));
					pCard4.getChildren().addAll(new Label("Player 4 name: " + enteredNames.get(3)), new Label("Player 4 balance: "));
					pCard1.setStyle("-fx-border-color: black");
					pCard2.setStyle("-fx-border-color: black");
					pCard3.setStyle("-fx-border-color: black");
					pCard4.setStyle("-fx-border-color: black");
		...
		for (int i = 0 ; i < prompts.size() ; i++) {
			prompts.get(i).setOnKeyReleased(event -> {
				if(event.getCode() == KeyCode.ENTER) {
					enteredNames.add(prompts.get(i).getText());
				}
			});
		}

		for (int i = 0 ; i < enteredNames.size() ; i++) {
			Player player = new Player(enteredNames.get(i), "" + i+1);
			players.add(player);
		}
		VBox checknames = new VBox();
			checknames.setStyle("-fx-border-color: black");
			for(Player player : players) {
				checknames.getChildren().add(new Label(player.getName()));
			}


	// adds all names to their corresponding squares (indexed from their lists)
		squares.get(0).getChildren().add(propertyNames.get(0));
		squares.get(1).getChildren().add(propertyNames.get(1));
		squares.get(2).getChildren().add(propertyNames.get(2));
		squares.get(3).getChildren().add(propertyNames.get(3));
		squares.get(4).getChildren().add(propertyNames.get(4));
		squares.get(5).getChildren().add(propertyNames.get(5));
		squares.get(6).getChildren().add(propertyNames.get(6));
		squares.get(7).getChildren().add(propertyNames.get(7));
		squares.get(8).getChildren().add(propertyNames.get(8));
		squares.get(9).getChildren().add(propertyNames.get(9));
		squares.get(10).getChildren().add(propertyNames.get(10));
		squares.get(11).getChildren().add(propertyNames.get(11));
		squares.get(12).getChildren().add(propertyNames.get(12));
		squares.get(13).getChildren().add(propertyNames.get(13));
		squares.get(14).getChildren().add(propertyNames.get(14));
		squares.get(15).getChildren().add(propertyNames.get(15));
		squares.get(16).getChildren().add(propertyNames.get(16));
		squares.get(17).getChildren().add(propertyNames.get(17));
		squares.get(18).getChildren().add(propertyNames.get(18));
		squares.get(19).getChildren().add(propertyNames.get(19));
		squares.get(20).getChildren().add(propertyNames.get(20));
		squares.get(21).getChildren().add(propertyNames.get(21));
		squares.get(22).getChildren().add(propertyNames.get(22));
		squares.get(23).getChildren().add(propertyNames.get(23));
		squares.get(24).getChildren().add(propertyNames.get(24));
		squares.get(25).getChildren().add(propertyNames.get(25));
		squares.get(26).getChildren().add(propertyNames.get(26));
		squares.get(27).getChildren().add(propertyNames.get(27));
		squares.get(28).getChildren().add(propertyNames.get(28));
		squares.get(29).getChildren().add(propertyNames.get(29));
		squares.get(30).getChildren().add(propertyNames.get(30));
		squares.get(31).getChildren().add(propertyNames.get(31));
		squares.get(32).getChildren().add(propertyNames.get(32));
		squares.get(33).getChildren().add(propertyNames.get(33));
		squares.get(34).getChildren().add(propertyNames.get(34));
		squares.get(35).getChildren().add(propertyNames.get(35));
		squares.get(36).getChildren().add(propertyNames.get(36));
		squares.get(37).getChildren().add(propertyNames.get(37));
		squares.get(38).getChildren().add(propertyNames.get(38));
		squares.get(39).getChildren().add(propertyNames.get(39));
